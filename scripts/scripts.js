    ...
    navUlChildren[i].addEventListener('click', () => { 
        ...
        for (let i = 0; i < navUlChildrenAnchorTags.length; i++) {
            ...
            if(navUlChildrenAttributes === 'home') { 
                navUlChildrenAnchorTags[i].setAttribute('href', 'https://www.ultimatedoorsncabinets.com/#'); 
                break;
            }

            navUlChildrenAnchorTags[i].setAttribute('href', 'https://www.ultimatedoorsncabinets.com/#' + navUlChildrenAttributes); 
        } 
    });  
